import { N as NoImageMetadata, Y as UnsupportedImageFormat, Z as AstroError, j as MissingSharp } from "./errors-data_Dp3HHhTD.mjs";
import { r as detector } from "./remoteProbe_DUr4cRdO.mjs";
import { i as resolveDefaultOutputFormat, n as baseService, r as parseQuality } from "./generic_CFZxv0YW.mjs";
//#region node_modules/.pnpm/astro@7.2.4_@emnapi+core@1._15e035042fc32a5f7aa0473e56a6646a/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./dist_CUvqlySZ.mjs")).default;
	} catch {
